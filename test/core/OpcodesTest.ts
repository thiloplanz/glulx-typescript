...
module FyreVM {
	...
	export module NodeUnit {
		...
		function check_byte_byte_store(m: MemoryAccess, test, opcode: string, a: number, b: number, expected: number) {
		...
		function check_byte_byte_byte_store(m: MemoryAccess, test, opcode: string, a: number, b: number, c: number, expected: number) {
		...
		function check_byte_int32_store(m: MemoryAccess, test, opcode: string, a: number, b3: number, b2: number, b1: number, b0: number, expected: number) {
		...
		function check_byte_store(m: MemoryAccess, test, opcode: string, x: number, expected: number) {
		...
		function check_int32_store(m: MemoryAccess, test, opcode: string, x3: number, x2: number, x1: number, x0: number, expected: number) {
		...
		function check_int16_int16_int16(m: MemoryAccess, test, opcode: string, a: number, b: number, c: number, expected: number) {
		...
		function check_stack(m: MemoryAccess, test, opcodes, expected, message) {
